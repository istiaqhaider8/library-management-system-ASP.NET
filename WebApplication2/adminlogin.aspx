                  ...
                  <div class="row">
                     <div class="col">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="adminMemberIdTextBox" runat="server" placeholder="Member ID"></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group">
                           <asp:Button class="btn btn-success btn-block btn-lg" ID="adminLoginButton" runat="server" Text="Login" OnClick="adminLoginButton_Click"  />
                        </div>
                     </div>
                  </div>
               </div>
